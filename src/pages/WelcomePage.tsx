    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-8 py-16 text-center">
        ...
        <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
          La plateforme éducative pour réviser vos formules de mathématiques et vous entraîner avec des exercices personnalisés de la 6<sup>e</sup> à la Terminale.
        </p>
        ...
        <div className="grid grid-cols-3 gap-8 mb-12">
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600">Toutes les formules essentielles à portée de main</p>
          </div>
          ...
          <div className="p-6">
            ...
            <p className="text-sm text-gray-600">Des exercices générés automatiquement pour progresser</p>
          </div>
        ...
        <div className="space-y-4 max-w-md mx-auto">
          <button
            ...
            className="w-full bg-indigo-600 text-white h-14 rounded-xl font-semibold hover:bg-indigo-700 transition-all shadow-lg"
          >
            Créer un compte
          </button>
          <button
            onClick={() => navigate('/login')}
            className="w-full bg-white border-2 border-gray-300 text-gray-700 h-14 rounded-xl font-semibold hover:bg-gray-50 transition-all"
          >
            J'ai déjà un compte
          </button>
        </div>
