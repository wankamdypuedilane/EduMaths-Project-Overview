    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-8 py-12">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-3">Sélectionnez votre classe</h1>
          <p className="text-lg text-gray-600">Nous adapterons le contenu à votre niveau</p>
        </div>
